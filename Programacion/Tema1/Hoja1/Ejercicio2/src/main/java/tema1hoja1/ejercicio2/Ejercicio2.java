...
package tema1hoja1.ejercicio2;

/**
 *
 * @author Asier
 */
public class Ejercicio2 { //DAW107 Asier Gonzalez
...
//con la orden println        
       ...
       System.out.println("el valor de la variable casado es " + casado);
        ...
        System.out.println("el valor de la variabletotalfactura es "+totalfactura);
...
//con la orden print        
       ...
       System.out.print("el valor de la variable casado es " + casado);
        ...
        System.out.print("el valor de la variabletotalfactura es "+totalfactura);
...
//con la orden printf
       ...
       System.out.printf("el valor de la variable casado es " + casado);
        ...
        System.out.printf("el valor de la variabletotalfactura es "+totalfactura);
