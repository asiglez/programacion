...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            String descripcionp = new Scanner(System.in).next();
            ...
            //creo el objeto
            matriz[i] = new EnPromocion(descuentop, codigop, descripcionp, preciop);
        }
        for (int i = 5; i < 10; i++) {
        ...
        for (int i = 0; i < 10; i++) {
            if (matriz[i] instanceof Perecedero) { // esta es una forma para castear objetos
                ...
                System.out.print("Año de caducidad" + pereaux.getAño() + "\n");
            }
